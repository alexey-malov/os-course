...
- [Лабораторная работа №3](#лабораторная-работа-3)
  ...
  - [Q\&A](#qa)
    ...
    - [3. Зачем и ограничить количество параллельно запущенных задач при использовании `std::async`?](#3-зачем-и-ограничить-количество-параллельно-запущенных-задач-при-использовании-stdasync)
...
### 3. Зачем и ограничить количество параллельно запущенных задач при использовании `std::async`?
